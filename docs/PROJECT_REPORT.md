> **Archived academic report.** This is the original COMP30019 Project 2 submission
> write-up, preserved for provenance. For the game itself — how to play, run, and
> deploy it — see the [main README](../README.md).
